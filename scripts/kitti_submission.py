...
if __name__ == '__main__':
    ...
    if not os.path.isdir(f'kitti_submission'):
        os.mkdir(f'kitti_submission')
        os.mkdir(f'kitti_submission/disp_0')
        os.mkdir(f'kitti_submission/disp_1')
        os.mkdir(f'kitti_submission/flow')
